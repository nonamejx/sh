...
import { QuestionShComponent } from 'app/entities/question-sh/question-sh.component';
...
describe('Component Tests', () => {
    describe('QuestionSh Management Component', () => {
        let comp: QuestionShComponent;
        let fixture: ComponentFixture<QuestionShComponent>;
        let service: QuestionShService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [ShTestModule],
                declarations: [QuestionShComponent],
                providers: [
                    {
                ...
                .overrideTemplate(QuestionShComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(QuestionShComponent);
