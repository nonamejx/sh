...
import { SectionShComponent } from 'app/entities/section-sh/section-sh.component';
...
describe('Component Tests', () => {
    describe('SectionSh Management Component', () => {
        let comp: SectionShComponent;
        let fixture: ComponentFixture<SectionShComponent>;
        let service: SectionShService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [ShTestModule],
                declarations: [SectionShComponent],
                providers: [
                    {
                ...
                .overrideTemplate(SectionShComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(SectionShComponent);
